...
CREATE TABLE `order_trackings` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `order_id` int(11) NOT NULL,
  `state` enum('waiting_for_shipper','preparing','on_the_way','delivered','cancel') CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `status` int(11) NOT NULL DEFAULT '1',
  `created_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  `updated_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
...
CREATE TABLE `users` (
  ...
  `role` enum('user','admin','shipper') CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT 'user',
...
('1', 'viettranx@gmail.com', NULL, NULL, 'cc63bb11e5729e60544a087accc4b2a2', 'QKUoulMfcMwRdFUBzNqpIZtWrgeOLvEZxZywouIzrUxFSzozwE', 'Tran', 'Viet', NULL, 'user', NULL, '0', '2021-01-24 14:40:08', '2021-01-24 14:40:08');
